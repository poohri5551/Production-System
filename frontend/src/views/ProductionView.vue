  ...
  <section class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      <div>
        ...
        <h1 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Production & Job list</h1>
        <p class="mt-2 max-w-2xl text-slate-500">
          Uses the existing Flask endpoints and MySQL data while the old Flask template remains available.
        </p>
      </div>
