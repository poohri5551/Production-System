  ...
  <section class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      <div>
        ...
        <h1 class="mt-2 text-3xl font-semibold tracking-tight text-slate-950">สถานะของชิ้นงาน</h1>
        <p class="mt-2 max-w-2xl text-slate-500">
          ติดตามสถานะของชิ้นงานว่าอยู่ในขั้นตอนใด 
        </p>
      </div>
      <button
        type="button"
    ...
    <div v-else-if="!items.length" class="shell-card p-10 text-center">
      ...
      <h2 class="text-lg font-semibold text-slate-900">No active plans found</h2>
      <p class="mt-2 text-sm text-slate-500">Create a Production Plan to start tracking workflow status.</p>
    </div>
