    ...
    <section class="grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-blue-100 bg-white shadow-soft md:grid-cols-[1.05fr_0.95fr]">
      <div class="relative hidden bg-gradient-to-br from-blue-600 to-sky-400 p-10 text-white md:block">
        ...
        <div class="relative flex h-full flex-col justify-between">
          <div>
            <div class="mb-8 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white/20 text-xl font-bold backdrop-blur">
              IP
            </div>
            <h1 class="text-4xl font-semibold leading-tight">Inventory Production System</h1>
          ...
          <div class="rounded-3xl bg-white/15 p-5 backdrop-blur">
            <p class="text-sm text-blue-50">Connected to existing backend APIs</p>
            <p class="mt-2 text-2xl font-semibold">/api/login</p>
          </div>
        </div>
      </div>
      ...
      <div class="p-8 sm:p-10">
        <div class="mb-8">
          ...
          <p class="mt-2 text-sm text-slate-500">ใช้ user เดิมจาก MySQL inventory_db</p>
        </div>
